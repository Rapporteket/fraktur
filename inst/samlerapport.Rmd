...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra fraktur
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "fraktur")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "fraktur"))`'
...
f <- fraktur::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
